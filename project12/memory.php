...
<div style="text-align: center; margin: 20px 0; padding: 0 20px;">
  <h1 style="font-size: 2.5rem; color: #333; margin: 0; font-family: 'Microsoft JhengHei Bold', 'Microsoft JhengHei', sans-serif;">🧠記憶力</h1>
</div>
...
<div id="double-player-section" class="section" style="display: none;">
  <div class="game-grid">
    <div class="game-block">
      <div class="game-item">
        <a href="Memory-Game-2P.php"><img src="img/card.jpg" alt="翻牌對對樂-雙人"></a>
      </div>
